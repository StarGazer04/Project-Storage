...
- only additional feature implemented was the creation of the array list. this use of the array was not mentioned from the reading, but ive known a bit of java before class and i prefer creating it the way it was used in my FractalDrawer class.
- no known bugs
